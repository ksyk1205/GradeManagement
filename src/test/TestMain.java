...
public class TestMain {
	...
	public void createStudent() {
		...
		goodSchool.addStudnet(student1);
		goodSchool.addStudnet(student2);
		goodSchool.addStudnet(student3);
		goodSchool.addStudnet(student4);
		goodSchool.addStudnet(student5);
